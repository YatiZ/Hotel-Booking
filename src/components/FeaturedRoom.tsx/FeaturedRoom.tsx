      ...
      <div className="md:py-10 md:w-1/2 text-left">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mt-5">
          <div className="flex mb-3 md:mb-0">
            <div className="flex flex-col gap-3 items-center justify-center mr-4">
              <p className="text-xs lg:text-xl text-center">Start Form</p>
          ...
          <Link
            ...
            className="border h-fit text-center border-tertiary-dark text-tertiary-dark px-3 py-2 lg:py-5 lg:px-7 rounded-2xl font-bold"
          >
            More Details
          </Link>
        </div>
